...
const AboutPage = () => {
	return (
		<div className="bg-secondary/10 p-5 text-secondary rounded-md lg:text-lg grid grid-flow-row gap-4 text-md">
			<div className="text-2xl flex justify-center font-bold">
				Ecommerce Personal Project
			</div>
			<div>
				This project is developed using{" "}
				<span className={textDesign}>MongoDB</span>,{" "}
			...
			<div>
				...
				<Image
					...
					height={40}
				/>
				&mdash; to design my components easier,{" "}
				<span className={textDesign}>Axios</span>
				&mdash;for my API requests,{" "}
				<span className={textDesign}>Redux Toolkit</span>{" "}
				<Image
					className="inline"
			...
			<div>
				...
				<span className={textDesign}>morgan</span>&mdash;HTTP request logger
				middleware for node.js,{" "}
				<span className={textDesign}>multer & multer-gridfs-storage</span>
				...
				<span className={textDesign}>express-async-handlers</span>
				&mdash;asynchronus express functions,{" "}
				<span className={textDesign}>cors</span>&mdash;allowing specific domains
				to access requests, <span className={textDesign}>dotenv</span>&mdash;for
				env variables
			</div>
		</div>
	);
